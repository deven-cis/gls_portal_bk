...
async def get_billing_by_job(
    ...
    return await apis.get_billing_by_job(job_no, db)
...
async def create_billing(
    ...
    return await apis.create_billing(
        job_no=job_no,
...
async def update_billing(
    ...
    return await apis.update_billing(
...
async def delete_billing(
    ...
    return await apis.delete_billing(billing_id, db)
