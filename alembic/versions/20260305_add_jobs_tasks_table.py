...
def upgrade():
    op.create_table(
        ...
        sa.Column('sms_provide_no', sa.Integer, nullable=True),
        ...
        sa.Column('salutaion', sa.String(1024), nullable=True),
        ...
        sa.Column('work_schedule_sta', sa.String(1024), nullable=True),
